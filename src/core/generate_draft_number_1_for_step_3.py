...
def main():
    ...
    new_step_3_result_path.mkdir(parents=True, exist_ok=True)

    with open(
        original_step_3_result_path / f"{slurm_unit_index}.pkl",
        "rb",
    ) as f:
        step_3_pickle_data = pickle.load(f)

    handle_intent(step_3_pickle_data, new_step_3_result_path)
