...
./venv/bin/python ../src/core/step_9_benign_draft_model_inference.py --slurm_unit_index "$SLURM_ARRAY_TASK_ID" --draft_model_name {{ draft_model_name }} --draft_number {{ draft_number }}